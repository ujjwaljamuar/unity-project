...
namespace MetaMask.Unity.Samples
{
    public class VisualController : MonoBehaviour
    {
        ...
        public Button PlayButton; // Integrate the Play Button
        ...
        private void Start()
        {
            ...
            this.metaMaskTest.onTransactionSent += OnTransactionSent; // Added this line
        ...
        public void OpenMainScreen()
        {
            ...
            // Show Play Button on the second page
        ...
        public void OpenWelcomeScreen()
        {
            ...
            // Hide Play Button on the first page
